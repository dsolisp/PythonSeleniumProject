...
class TestDataManager:
    ...
    def __init__(self, data_directory: Union[str, Path] = None):
        ...
        self.data_dir = Path(data_directory) if data_directory else Path(__file__).parent.parent / "data"
        self.data_dir.mkdir(parents=True, exist_ok=True)
        self._cache = {}
        self._generators = self._setup_generators()

    def load_test_data(self, filename: str, environment: str = "default") -> Dict[str, Any]:
        """
    ...
    def get_user_accounts(self, role: str = None, environment: str = "default") -> List[Dict[str, Any]]:
        """
    ...
    def get_api_endpoints(self, method: str = None, environment: str = "default") -> List[Dict[str, Any]]:
        """
        ...
        if method:
            endpoints = [ep for ep in endpoints if ep.get("method", "").upper() == method.upper()]
            
        return endpoints

    def get_browser_configurations(self, browser: str = None, mobile: bool = None, 
                                 environment: str = "default") -> List[Dict[str, Any]]:
        """
    ...
    def validate_data_schema(self, data: Dict[str, Any], schema_name: str) -> bool:
        ...
        schemas = {
            "search_scenario": {
                ...
                "optional": ["expected_results_count", "timeout", "expected_title_contains"]
            },
            "user_account": {
    ...
    def _get_env_file_path(self, filename: str, environment: str, extension: str) -> Path:
