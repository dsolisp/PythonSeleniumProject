...
async def test_playwright_simple_navigation():
    ...
    try:
        ...
        # Increase timeout and use a more reliable test URL
        test_url = "https://example.com"
        await page.page.goto(test_url, timeout=30000, wait_until="domcontentloaded")
        ...
        try:
            ...
            try:
                ...
                print(
                    f"🔍 Body text (first 200 chars): "
                    f"{all_text[:200] if all_text else 'None'}"
                )
...
async def test_playwright_factory_browsers():
    for browser_type in ["chromium", "firefox"]:
        ...
        try:
            ...
            assert_that(content, contains_string("Example Domain"))
