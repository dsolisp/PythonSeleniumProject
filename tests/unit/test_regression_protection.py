...
class TestRegressionProtection:
    ...
    def test_webdriver_factory_exists(self):
        ...
        assert_that(
            factory, has_property("create_chrome_driver")
        ), "WebDriverFactory missing create_chrome_driver method"
        assert_that(
            factory, has_property("create_firefox_driver")
    ...
    def test_base_page_exists(self):
        ...
        assert_that(
            BasePage, has_property("__init__")
    ...
    def test_database_connection_function_exists(self):
        ...
        assert_that(
            callable(get_connection), is_(True)
    ...
    def test_requirements_file_exists(self):
        ...
        assert_that(
            os.path.exists(requirements_path), is_(True)
        ), "requirements.txt file not found"

        with open(requirements_path, "r") as f:
            content = f.read()
            assert_that(
                content, contains_string("selenium")
            ), "selenium not found in requirements.txt"
            assert_that(
                content, contains_string("pytest")
    ...
    def test_config_directory_structure(self):
        ...
        for dir_name in essential_dirs:
            ...
            assert_that(
                os.path.exists(dir_path), is_(True)
